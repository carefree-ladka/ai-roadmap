---
title: Python
description: A complete Python roadmap in four phases — fundamentals, data structures, OOP, and professional Python — the foundation for FastAPI and AI.
slug: /01-python
---
...
not a setup page — organized into **four phases** that take you from syntax to
async, typing, testing, and clean backend structure.
:::
